---
title: "Utilize HDF5 object `` "
author:
  - name: Sean K. Maden
    affiliation:
    - &libd Computational Biology Program, Dept. of Biomedical Engineering, OHSU
    email: maden@ohsu.edu
  - name: Abhi Nellore
    affiliation:
    - &libd Computational Biology Program, Dept. of Biomedical Engineering, OHSU
    - &ccb Dept. of Surgery, OHSU
...
The packages `GEOquery` and `GEOmetadb` provide additional data and 
utilities for that can aid with validation.
